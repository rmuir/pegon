...
([
  ...
  (#set! note "Escape the character: only 0x20 may appear in literals"))
...
((escape_sequence) @error
  ...
  (#set! note "Replace the raw escape with the special escape \\b"))
...
((escape_sequence) @error
  ...
  (#set! title "Special escape sequence in octal/hex form")
  (#set! label "Raw escape used here")
  (#set! note "Replace the raw escape with the special escape \\f"))
...
((escape_sequence) @error
  ...
  (#set! title "Special escape sequence in octal/hex form")
  (#set! label "Raw escape used here")
  (#set! note "Replace the raw escape with the special escape \\r"))
...
((decimal_integer_literal) @error
  ...
  (#set! note "Change to an uppercase L suffix to improve legibility"))
...
((identifier) @error
  ...
  (#set! note "Change to use only ASCII letters, digits, and underscores"))
...
((package_declaration
  ...
  (#set! label "package declared here")
  (#set! note "Change package name to use lowercase and digits"))
...
((module_declaration
  ...
  (#set! note "Change module name to use lowercase and digits"))
...
((class_declaration
  ...
  (#set! note "Change class name to use UpperCamelCase"))
...
(formal_parameters
  ((formal_parameter
    ...
    (#set! note "Change parameter name to use lowerCamelCase"))) @visible
...
(local_variable_declaration
  ...
  (#set! note "Change variable name to use lowerCamelCase: not static final")) @visible
...
((type_parameter
  ...
  (#set! note "Change type name to use UpperCamelCase"))
...
(catch_clause
  ...
  (#set! note "Handle the exception, add a comment, or indicate via unnamed variable _")) @visible
