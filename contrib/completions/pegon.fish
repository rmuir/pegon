...
complete -c pegon -n "__fish_pegon_using_subcommand format" -s V -l version -d 'Print version'
...
complete -c pegon -n "__fish_pegon_using_subcommand server" -s V -l version -d 'Print version'
